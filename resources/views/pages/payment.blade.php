                        ...
                        <form action="{{ route('payment.process') }}" id="contact_form" method="post">
                           ...
                           <div class="form-group">
                                <ul class="logos_list " >
                                            ...
                                            <li><input type="radio" name="payment" value="paypal"> <img src="{{ asset('public/frontend/images/logos_3.png') }}" style="width: 65px; height: 30px;"></li>
                                             <li><input type="radio" name="payment" value="ideal"> <img src="{{ asset('public/frontend/images/logos_4.png') }}" style="width: 50px; height: 30px;"></li>
                                 </ul>
                            </div><br>
