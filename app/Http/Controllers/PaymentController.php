...
class PaymentController extends Controller
{
    ...
    public function STripeCharge(Request $request)
    {
        ...
        \Stripe\Stripe::setApiKey('sk_test_51Jf5TPK5om6Z0UVhDwDTMQ5Pp13SbWQ3U6F1K3ZPrIkveDdi2kbwYsK7jDcNaVEXF8zCyFH1t8XuIuU8nzy0FNkD00wwuMIAu3');
        ...
        $charge = \Stripe\Charge::create([
            'amount' => $total * 100,
            'currency' => 'usd',
            'description' => 'Abdur Rahim details',
            'source' => $token,
